...
public class Billiards extends JFrame {
	...
	public Billiards() {
		...
		setTitle("Pr醕tica programaci髇 concurrente objetos m髒iles independientes");
		setResizable(false);
		setVisible(true);
	}
	...
	private class StartListener implements ActionListener {
		...
		public void actionPerformed(ActionEvent arg0) {
			// Por no complicar mucho m谩s la estructura del c贸digo
			// de la pr谩ctica hemos incluido aqu铆 mismo algunas comprobaciones 
			// para mantener consistente la ejecuci贸n en relaci贸n
			// a las posibles interacciones del usuario.
			if (hilos==null)
				//S贸lo creamos el array de hilos la primera vez
